...
# try:
#     while page <19:
#         # url = "https://ev10.az/api/v1.0/postings?page_number=19&media_type=image&sort_by=date_desc&sale_type=LEASE&lease_type=MONTHLY&sponsor_seed=752219&sponsor_skip=216&sponsor_limit=12&search_type=filter&property_type=apartment&page_size=50&location_ids=187&location_ids=186&location_ids=208&location_ids=197"
#         url = f"https://ev10.az/api/v1.0/postings?page_number={page}&media_type=image&sort_by=date_desc&sale_type=LEASE&lease_type=MONTHLY&sponsor_seed=1782230267275&sponsor_skip=0&sponsor_limit=12&search_type=filter&property_type=apartment&page_size={page_size}&location_ids=187&location_ids=186&location_ids=208&location_ids=197"
...
"""
her sehifede page_num uygun olaraq deyisir
ilk sehife size=50
[2-37] sehifelerde size =24
38-ci sehifede size = 18 
"""
    
# with open("ev10_page18.json", "r", encoding="utf-8") as f:
#     file = json.load(f)
    
# ids = []

# for i in file["postings"]:
#     ids.append(i["id"])
...
# with open("ev10_page19.json", "r", encoding="utf-8") as f:
#     file = json.load(f)
...
#     )
#     insert_query = ("""
#         INSERT OR REPLACE INTO rent_ev10(rent_id,link,latitude,longitude,price,rooms,floor,building_type,checked)
#         VALUES(?,?,?,?,?,?,?,?,?)""")
